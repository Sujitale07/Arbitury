      ...
      <div style={{ 
        ...
        <div style={{ maxWidth: 480 }}>
          <h1 style={{ fontSize: '3.5rem', lineHeight: 1.1, marginBottom: 24, fontFamily: 'var(--serif)' }}>
            Cultivate your business with <span style={{ color: 'var(--primary)' }}>precision.</span>
          </h1>
          <p style={{ fontSize: '1.2rem', color: 'var(--text-2)', marginBottom: 48 }}>
            The all-in-one workspace for organic wellness brands and seed distributors.
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            <div style={{ display: 'flex', gap: 16 }}>
              ...
              <div>
                <h3 style={{ fontWeight: 600, marginBottom: 4 }}>AI-Powered Insights</h3>
                <p style={{ color: 'var(--text-3)' }}>Predictive analytics for inventory and sales growth.</p>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 16 }}>
              <div style={{ color: 'var(--primary)', marginTop: 4 }}><ShieldCheck size={20} /></div>
              <div>
                <h3 style={{ fontWeight: 600, marginBottom: 4 }}>Secure Collaboration</h3>
                <p style={{ color: 'var(--text-3)' }}>Invite teammates and manage roles with ease.</p>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 16 }}>
              <div style={{ color: 'var(--primary)', marginTop: 4 }}><Zap size={20} /></div>
              <div>
                <h3 style={{ fontWeight: 600, marginBottom: 4 }}>Lightning Fast</h3>
                <p style={{ color: 'var(--text-3)' }}>Optimized for speed so you can focus on growing.</p>
              </div>
            </div>
          </div>
        </div>
